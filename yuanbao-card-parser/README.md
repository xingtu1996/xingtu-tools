***REMOVED*** 元宝卡片解析器 · Yuanbao Card Parser
...
1. 用浏览器直接打开 `index.html`：
   ...
   ***REMOVED*** 然后访问 http://localhost:8080
   ```
...
***REMOVED******REMOVED*** 输入示例

***REMOVED******REMOVED******REMOVED*** 模式一：HTML 源码
...
***REMOVED******REMOVED******REMOVED*** 模式二：卡片文本
...
***REMOVED******REMOVED******REMOVED*** Q: 我把 `https://yb.tencent.com/...` 链接粘贴进去，为什么解析失败？
