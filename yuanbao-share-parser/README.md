...
***REMOVED******REMOVED*** 典型用法：批量归档转给元宝的 AI 摘要

```bash
***REMOVED*** 把一批链接丢进 links.txt，逐条抓取为 Markdown
while read url; do
...
***REMOVED******REMOVED*** 与现有管线（yuanbao_fetch.py）的关系
